...
<div class="content">
    <div class="testbox">
        <form action="addtolib" method="post">
            <div class="banner">
                <h1>New Member To The Library</h1>
            </div>
<%--            <div class="colums">--%>
<%--                <div class="item">--%>
<%--                    <label for="">Book's Title</label>--%>
<%--                    <input id="" type="text" name="title" value="<%= EditDeleteCall.title %>" readonly/>--%>
<%--                </div>--%>
<%--                <div class="item">--%>
<%--                    <label for="">Author Name</label>--%>
<%--                    <input  type="text" name="authorname" value="<%= EditDeleteCall.authorname %>" readonly/>--%>
<%--                </div>--%>
<%--                <div class="item">--%>
<%--                    <label for="">Publisher Name</label>--%>
<%--                    <input  type="text"   name="publishername" value="<%= EditDeleteCall.publishername %>" readonly/>--%>
<%--                </div>--%>
<%--                <div class="item">--%>
<%--                    <label for="">Published Year</label>--%>
<%--                    <input type="text"   name="publisherdate" value="<%= EditDeleteCall.publisheddate %>" readonly/>--%>
<%--                </div>--%>
<%--                <div class="item">--%>
<%--                    <label for="">Genre</label>--%>
<%--                    <input i type="text"   name="genre" value="<%= EditDeleteCall.genre %>" readonly/>--%>
<%--                </div>--%>
<%--                <div class="item">--%>
<%--                    <label for="">Category<span>*</span></label>--%>
<%--                    <input i type="text" name="category" required/>--%>
<%--                </div>--%>
...
<%--            </div>--%>
            ...
            %>
            <div style="margin: 30px 0px;" class="table-wrapper">
                <table class="fl-table">
                    ...
                    <%
                        ...
                        {
//                            ResultSet rs=addtoLibCall.bdetails(AddtoLibCall.bookdetails.get(i));
                            JSONObject bookval=addtoLibCall.bdetails(AddtoLibCall.bookdetails.get(i));
            ...
            <div class="colums">
                <div class="item">
                    <label for="">Choose an existing Library</label><br>
                    <select class="chooselib" name="category" >
                        <option class="chooselib" value="null" hidden>Choose..</option>
                        <option class="chooselib" value="none">None</option>
                        <%
                            int dropflag=0;
                ...
                <div class="item">
                    <label for="">Add New Library</label>
                    <input style="margin-top: 10px" id="" type="text" name="category1"/>
                </div>

<%--                <div class="item">--%>
<%--&lt;%&ndash;                    <label for="">Book's Title</label>&ndash;%&gt;--%>
<%--                    <select class="chooselib" name="sortval" ><br>--%>
<%--                        <option class="chooselib" hidden value="choose a Library">Choose..</option>--%>
<%--                        &lt;%&ndash;                        <option class="chooselib" value="none">None</option>&ndash;%&gt;--%>
<%--                        <%--%>
<%--                            int dropflag=0;--%>
<%--                            ArrayList<String> opt=addtoLibCall.options();--%>
<%--                            for(int i=0;i<opt.size();i++)--%>
