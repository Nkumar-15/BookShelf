...
//    }
    ...
    UserBookShelf.userlibbookdata.clear();
    bookShelf.userlibviewdata();
    if(UserBookShelf.sortsearchflag ==1)
    {
    ...
    else if(UserBookShelf.sortsearchflag ==2)
    {
        bookShelf.sortdisplay();
        //System.out.println("In sortdisplay");
    }
    else if(UserBookShelf.sortsearchflag==3)
    {
       bookShelf.searchdisplay();
        UserBookShelf.sortsearchflag=1;
    }
    int flag=0;
        ...
        <div class="col-sm-6">
            <div class="card1">
                <div class="dropdown">
                    ...
                    <%--                                <a href="#">Link 3</a>--%>
                    <%--                            </div>--%>
                    <form action="usersort" method="POST">
...
<%--                            <optgroup class="selectsortopt" label="Category">--%>
<%--                                <option class="selectsortopt" value="Category ASC">Ascending Order</option>--%>
<%--                                <option class="selectsortopt" value="Category DESC">Descending Order</option>--%>
<%--                            </optgroup>--%>
                        </select>
        ...
        <div class="col-sm-6">
            <div class="card1">
                <h3>Current Library : <span style="color: #22242A"><%= UserBookShelf.category %></span></h3>
            </div>
        </div>
...
<%--                <th>Category</th>--%>
            ...
            <tbody>
                <%
                    int count=0;
                    for(int i=UserBookShelf.start;i<UserBookShelf.userlibviewbookdata.size();i++)
                    {
                        if(count==10)
                            {
                                break;
                            }
                        JSONObject bookval=UserBookShelf.userlibviewbookdata.get(i);
                        flag=1;
                %>
            <tr>
    ...
    <div class="button_prevnext">
        <form action="userprevnext" method="POST">
