<%@ page import="UserBookShelf.UserProfile" %>
...
<body>
  <%
    ...
    ResultSet rs=null;
    rs=userProfile.userpro(username);
    %>
        ...
        <form action="userprofileedit" method="post">
          ...
          <div class="colums">
            ...
            <div class="item">
              ...
              <input id="" type="text" name="Username" value="<%= rs.getString(1) %>" required/>
            </div>
            <div class="item">
            ...
            <div class="item">
              ...
              <input  type="text"   name="password" value="<%= rs.getString(3) %>" required/>
            </div>
<%--            <div class="item">--%>
<%--              <label for="">Published Year<span>*</span></label>--%>
<%--              <input type="text"   name="publisherdate" value="<%= rs.getString(1) %>" required/>--%>
<%--            </div>--%>
<%--            <div class="item">--%>
<%--              <label for="">Genre<span>*</span></label>--%>
<%--              <input i type="text"   name="genre" value="<%= rs.getString(1) %>" required/>--%>
<%--            </div>--%>
